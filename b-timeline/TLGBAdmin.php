...
class TLGBAdmin {
    ...
    public static function register_post_type() {
        $labels = array(
            'name' => __('B-Timeline', 'timeline-block'),
            'menu_name' => __('B-Timeline', 'timeline-block'),
            'name_admin_bar' => __('B-Timeline', 'timeline-block'),
            ...
            'all_items' => __('All Timeline', 'timeline-block'),
        ...
        if ($post->post_type == 'btimeline'): ?>
            <div class="bptl_shortcode">
                <div class="shortcode-heading">
                    <div class="icon"><span class="dashicons dashicons-shortcode"></span> <?php _e("B-Timeline", "timeline-block") ?>
                    </div>
