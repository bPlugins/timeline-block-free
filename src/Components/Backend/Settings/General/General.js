...
const General = ({ attributes, setAttributes, removeTimeline, activeIndex, addTimeline, duplicateTimeline, updateTimeline, premiumProps, updateObj }) => {
    ...
    <>
      ...
      <PanelBody className='bPlPanelBody addRemoveItems' title={__('Add or Remove timelines', 'timeline-block')}>
        <SelectControlPro
          ...
          {...premiumProps}
          proValues={['timeline-with-accordion', 'theme-2', 'theme-3', 'theme-4', 'theme-5', 'theme-6']}
        />
        ...
        {null !== activeIndex && <>
          ...
          <PanelRow>
            ...
            <TextControl value={label} onChange={val => {
