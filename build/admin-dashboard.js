...
const Layout = props => {
  ...
  }, navigation?.filter(item => !isPremium || !["/purchase", "/pricing"].includes(item.href)) // Hide link for premium users
...
const changelogs = [{
  ...
  list: ["Fixed horizontal timeline issue", "Optimized plugin files & increase code readability"]
}, {
...
const pricingInfo = {
  ...
  features: ["ShortCode supported", "A lagacy version of Timeline plugin.", "Add Classic Editor for Timeline Description", "7 Brand New Unique Timeline Templates", "Responsive Design", "Customization Options for All Templates"],
  button: {
    label: "Buy Now ➜"
  },
  featured: {
